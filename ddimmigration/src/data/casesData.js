...
本案例为 Partner of an Accredited Employer Work Visa 路径下的**开放工签**（open）：持证人**可为新西兰境内任意雇主的任意职业**提供劳动服务（以批注英文条款为准，常见表述为不绑定单一雇主/岗位）。

【典型家庭规划价值】
✔ 主申请人稳定就业的同时，配偶可独立积累本地收入与经验
✔ 与主签长度、关系证明材料及后续续签/居民路径需整体规划
✔ 工作范围虽为「开放」，仍须符合签证条件、税务与就业合规

审批节奏、批注全文及旅行次数等，以新西兰移民局当次批准函为唯一依据。`,
  },
  {
    id: 61,
